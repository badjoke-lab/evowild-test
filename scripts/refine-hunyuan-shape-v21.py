...
def refine_shape(obj):
    ...
    for v in obj.data.vertices:
        ...
        z += head_sign*length*(0.045*pure_head + 0.085*crest_zone)
        y += height*(0.006*pure_head + 0.012*crest_zone)
        ...
        x = cx + (x-cx)*(1.0 - 0.045*shoulder - 0.055*rump)
...
def main():
    ...
    stats["status"]="shape_refine_v2_1_candidate_not_canonical"
    ...
    print("SHAPE_V21",json.dumps(stats,separators=(",",":")))
