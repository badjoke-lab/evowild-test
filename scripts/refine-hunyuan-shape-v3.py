...
def refine_shape(obj):
    ...
    for v in obj.data.vertices:
        ...
        x = cx + (x-cx)*(1.0-0.10*tail_stream)
        y = tail_center_y + (y-tail_center_y)*(1.0-0.11*tail_stream)
        z -= head_sign*length*0.028*tail_stream
...
def main():
    ...
    stats["status"]="shape_refine_v3_candidate_not_canonical"
    ...
    print("SHAPE_V3",json.dumps(stats,separators=(",",":")))
