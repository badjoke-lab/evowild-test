...
export const CREATURE_3D_PROFILES = {
  ...
  sHunyuan2mvLod4Rigged: {
    ...
    notes: [
      "LOD4 Hunyuan mesh with the same Blender-generated 13-bone armature and 25-frame run cycle.",
      "Performance proof for many simultaneously animated racers; not approved final animation."
    ]
  },
  sHunyuan2mvStyled: {
