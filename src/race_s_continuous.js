...
const MOTION_REVIEW_MODE = true;
const TAU = Math.PI * 2;
canvas.dataset.mode = "s-continuous-motion";
canvas.dataset.creatureCount = "1";
canvas.dataset.agent = "off";
canvas.dataset.hud = "off";
canvas.dataset.gaitSource = "motion-first-s-gait-v3";
const S_GAIT = {
  baseY: 1.60,
  reviewBaseY: 2.16,
  minStrideWorld: 3.8,
